...
This module (distributed train -> dtrain) provides the way to train a net on a dataset: in particular you can:
...
#   X, T the dataset samples + the desired output: they come in the shape (dimensions, num_of_samples) <- seach column a sample
#   epochs, the number of epochs we want to train the net
#   {train, validation, test}_percentage, the percentage of the dataset that is used for train, validation and testing, respectively
