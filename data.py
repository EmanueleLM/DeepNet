...
#   a m*n matrix
def randomData(n, m):
    X = np.random.rand(m, n, 1); # train set, except the target feature, generated by a random gaussian function with unitary mean and null variance
    return X;
