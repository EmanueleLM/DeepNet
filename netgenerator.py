...
MAX_NUM_NEURONS = 50; # maximum number of neurons a layer can have
...
def evaluateFitness(nets, w0, w1):
...
""" Test part """
population_size = 30;
epochs = 20; # number of epochs we want to iterate the ga routine
nets = randomPopulation(64, 10, population_size); # create the population 
crossover_probability = .95;
mutation_probability = .1;
elite_size = 5;

population = evaluateFitness(nets, .9, .1); # train and validate the initial population
for e in range(epochs):
    ...
    for n in range(int(population_size/2)):
        ...
        crossovers_dict["one-point"](population[id1][0], population[id2][0], crossover_probability); # apply crossover 
        mutations_dict["random"](population[id1][0], mutation_probability);
        mutations_dict["random"](population[id2][0], mutation_probability);
    population = evaluateFitness(list([p[0] for p in population]), .9, .1); # train and validate the initial population
