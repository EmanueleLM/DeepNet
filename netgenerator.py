...
def evaluateFitness(nets):
    ...
    for n in range(len(nets)):
        """ in this part we need to evaluate the fintess of a single network,
            ...
            fitness of each net """
        population[n][1] = (1-validateNet(population[n][0])) + (1-(num_parameters_per_net[n]/max_num_parameters)); # calculate the fitness, this part should be massively parallelized
    return population;
...
""" Test part """
nets = randomPopulation(64, 10, 2); # create the population 
