...
selection_dict = {"rank": sel.rankSelection, "roulette": sel.rouletteSelection}; # dict for the various selection methods
...
def randomPopulation(input_size, output_size, population_size, fully_connect=True, connection_perc = .5):
...
def validateNet(net, misclassified=False):
